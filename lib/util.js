...
/**
	@desc						Transforms a NodeJS callback-based function to a promise-based one.
	@param {Function} p_fn		The NodeJS function.
	@returns {Function}			The transformed function.
*/
module.exports.promise.denodeify = function(p_fn) {
	return function() {
		return module.exports.promise.nfapply(p_fn, Array.from(arguments));
	};
};

/**
	@desc						Transforms a a promise-based function to NodeJS callback-based one.
	@param {Function} p_fn		The promise-based function.
	@returns {Function}			The transformed function.
*/
module.exports.promise.nodeify = function(p_fn) {
	return function(/*..., p_callback*/) {
		let args = Array.from(arguments);
		let callback = args.pop();
		p_fn.apply(p_fn, args)
		.then(function(p_result) {
			callback(null, p_result);
		}, function(p_error) {
			callback(p_error);
		});
	};

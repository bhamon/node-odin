...
/**
	@desc							Returns a specialized child instance of this log.
	@param {Object} p_context		Child log context.
	@returns {module:odin.Log}		A child instance of this log.
*/
Log.prototype.child = function(p_context) {
	return this._log.child(p_context);
};
